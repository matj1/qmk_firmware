 ...
 * | \      | Z      | X      | C      | V      | B      | [      | UP     | ]      | K      | M      | ,      | .      | /      | '      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | LCTRL  | LGUI   | APP    | LALT   | _FN    | SPACE  | LEFT   | DOWN   | RIGHT  | SPACE  | RALT   | _FN    | SYSTEM | RGUI   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_LCTL, KC_LGUI, KC_APP,  KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_0,    KC_RALT, KC_TRNS, KC_TRNS, KC_RGUI, KC_RCTL },
 }
