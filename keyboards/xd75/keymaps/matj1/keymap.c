...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | \      | Z      | X      | C      | V      | B      | [      | UP     | ]      | N      | M      | ,      | .      | /      | '      |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
   * | LCTRL  | LGUI   | APP    | LALT   | FN0    | SPACE  | LEFT   | DOWN   | RIGHT  | SPACE  | RALT   | FN1    | _KBD   | RGUI   | RCTRL  |
   * '--------------------------------------------------------------------------------------------------------------------------------------'
   */
   ...
   * | \      | Z      | X      | C      | V      | B      | [      | UP     | ]      | K      | M      | ,      | .      | /      | '      |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
   * | LCTRL  | LGUI   | APP    | LALT   | _FN    | SPACE  | LEFT   | DOWN   | RIGHT  | SPACE  | RALT   | _FN    | _KBD   | RGUI   | RCTRL  |
   * '--------------------------------------------------------------------------------------------------------------------------------------'
   */
   ...
   * |        | S      | T      | P      | H      | *      |        |        |        | *      | F      | P      | L      | T      | D      |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
   * |        | S      | K      | W      | R      | *      |        | UP     |        | *      | R      | B      | G      | S      | Z      |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+---- ---+--------+--------+--------+--------+--------|
   * |        |        | _FN    | A      | O      |        | LEFT   | DOWN   | RIGHT  |        | E      | U      | _FN    | _KBD   |        |
   * `--------------------------------------------------------------------------------------------------------------------------------------'
   */

  [_STN] = { /* STENO */
    { XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_PGUP,  KC_HOME, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX },
    { STN_N1,  STN_N2,  STN_N3,  STN_N4,  STN_N5,  STN_N6,  KC_DEL,  KC_PGDN,  KC_END,  STN_N7,  STN_N8,  STN_N9,  STN_NA,  STN_NB,  STN_NC  },
    { XXXXXXX, STN_S1,  STN_TL,  STN_PL,  STN_HL,  STN_ST1, XXXXXXX, XXXXXXX,  XXXXXXX, STN_ST3, STN_FR,  STN_PR,  STN_LR,  STN_TR,  STN_DR  },
    { XXXXXXX, STN_S2,  STN_KL,  STN_WL,  STN_RL,  STN_ST2, XXXXXXX, KC_UP,    XXXXXXX, STN_ST4, STN_RR,  STN_BR,  STN_GR,  STN_SR,  STN_ZR  },
    { XXXXXXX, XXXXXXX, XXXXXXX, MO(_FN), STN_A,   STN_O,   KC_LEFT, KC_DOWN,  KC_RGHT, STN_E,   STN_U,   MO(_FN), MO(_KBD), XXXXXXX, XXXXXXX }
  },
